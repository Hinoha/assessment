...
function removeAllChildren(element) {
    while (element.firstChild) { //result-areaに何かタグがある限りループ
        element.removeChild(element.firstChild);
    }
}

/**
 * 指定した要素に診断結果用のタブを指定する。
 * @param {HTMLElement} element HTMLの要素
 ...
 */
function appendTweetButon(element, message) {
    //aタグを作って属性を設定する
    ...
    a.setAttribute('date-text', message);
...
assessmentButton.onclick = function () {
    ...
    appendTweetButon(tweetDivided, result);
}
